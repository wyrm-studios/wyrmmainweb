...
(function () {
    ...
    var M = [
        ...
        /* ---- inquiry ---- */
        ['Inquiry', 'Demande de projet', 'طلب مشروع'],
        ...
        ['Seven quick questions. Under two minutes. A real reply within 24 hours — from a person, not a bot.',
         'Sept questions rapides. Moins de deux minutes. Une vraie réponse sous 24 h — par une personne, pas un robot.',
         'سبعة أسئلة سريعة. أقل من دقيقتين. رد حقيقي خلال 24 ساعة — من شخص، لا روبوت.'],
        ['Reply in 24 hours', 'Réponse sous 24 h', 'رد خلال 24 ساعة'],
        ['Every inquiry, answered.', 'Chaque demande reçoit une réponse.', 'كل طلب يحصل على رد.'],
        ...
        ['Your inquiry has been sent to studioswyrm@gmail.com', 'Votre demande a été envoyée à studioswyrm@gmail.com', 'تم إرسال طلبك إلى studioswyrm@gmail.com'],
